...
<head>
    ...
    <link rel="stylesheet" href="{{asset('website_assets')}}/fonts/icomoon/style.css">
    ...
    <link rel="stylesheet" href="{{asset('website_assets')}}/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="{{asset('website_assets')}}/fonts/flaticon/font/flaticon.css">
...
<script src="{{asset('website_assets')}}/js/jquery-migrate-3.0.1.min.js"></script>
...
<script src="{{asset('website_assets')}}/js/jquery.countdown.min.js"></script>
