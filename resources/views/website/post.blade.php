...
@section('content')
  <div class="site-wrap">
    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('website_assets')}}/images//img_2.jpg');">
      <div class="container">
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="row mb-5 mt-5">
              <div class="col-md-12 mb-4">
                <img src="{{asset('website_assets')}}/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="{{asset('website_assets')}}/images/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="{{asset('website_assets')}}/images/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
            </div>
