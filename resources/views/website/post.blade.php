                        ...
                        <div class="post-entry text-center">
                            ...
                            <div class="post-meta align-items-center text-center">
                                <figure class="author-figure mb-0 mr-3 d-inline-block"><img
                                        src="{{asset('website_assets')}}/images/person_1.jpg" alt="Image"
                        ...
                        <div class="pt-5">
                            ...
                            @foreach($comments as $comment)
                                <ul class="comment-list">
                                    <li class="comment">
                                        <div class="vcard">
                                            <img src="{{asset('website_assets')}}/images/person_1.jpg"
                                        ...
                                        <div class="comment-body">
                                            ...
                                            <p><a href="javascript:void(0)" onclick="reply(this)"
                                                  class="reply rounded heelo"
                                            ...
                                            <ul class="children">
                                                <li class="comment">
                                                    ...
                                                    <div class="comment-body">
                                                        ...
                                                        <p>{{$reply->reply}}</p>
                                                        <p><a href="javascript:void(0)" onclick="reply(this)"
                                                              class="reply rounded " data-Commentid="{{$comment->id}}">Reply</a>
                                                        </p>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="comment-form-wrap pt-5">
                                ...
                                <form action="{{route('website.comment')}}" method="post" class="p-5 bg-light">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$post->id}}" name="post_id" class="btn btn-primary"
                                               hidden>
                                    </div>
                                </form>
                            </div>
                            <div style="display:none" class="replyDiv p-5">
                                <form action="{{route('website.reply')}}" method="post">
                                    ...
                                    <a type="submit" href="javascript:void(0);" class="btn btn-primary"
